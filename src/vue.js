...
let tabs = [
    ...
    },
    {
        ...
        examples: [
            ...
            {
                text1: 'Сколько процентов поверхности Земли покрывает вода?'
            },
            {
                text1: 'Где расположен международный аэропорт Никола Тесла?'
            },
            {
                text1: 'В каком году Декартом был предложен координатный метод?'
            }
        ],
...
Kensington Palace said in a statement that the couple is “hugely grateful” for the many good wishes they have received and they hope the carriage ride will give the general public a chance to take part.',
    ...
    },
    {
        ...
        <br><br>This component helps solve various business problems such as ticketing and booking services, renting and scheduling, accepting orders, consulting and customer support (if you train our model on your data).' +
