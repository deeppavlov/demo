...
function squadReport(t1, t2, response) {
    ...
    var res = '<blockquote class="blockquote" style="color: darkblue;">' + answer + '</blockquote>';
    if (t2) {
...
var tabs = [{
    ...
    examples: [{
        text1: 'Сколько островов входит в Фиджи?'
    }, {
        text1: 'Кто такой Антон Корбейн?'
    }, {
        text1: 'Откуда взялись морские свинки?'
    }, {
        text1: 'Кем работает Николас Кейдж?'
    }, {
        text1: 'К какому городу относится аэропорт Логана?'
    }, {
        text1: 'Где живет Ктулху?'
    }, {
        text1: 'Как звали первого пилота Гандама?'
    }],
